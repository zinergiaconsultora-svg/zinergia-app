-- Minimal read model for the daily CRM opportunity queue.
-- RLS is inherited from every base relation through security_invoker.

CREATE VIEW public.crm_work_queue
...
COMMENT ON VIEW public.crm_work_queue IS
    'RLS-aware, read-only operational queue for open CRM opportunities. Contains no plaintext sensitive identity fields.';

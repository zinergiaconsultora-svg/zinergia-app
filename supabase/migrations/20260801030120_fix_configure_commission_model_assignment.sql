...
BEGIN
    ...
    INSERT INTO public.commission_plans (
        code, version, name, channel, commercial_share_bps, franchise_share_bps,
        central_share_bps, effective_from, created_by
    ) VALUES (
        'partner_direct', direct_version, btrim(p_direct_name), 'partner_direct',
        p_direct_commercial_share_bps, 0, direct_central_bps, effective_at, p_actor_id
    )
    ...
    INSERT INTO public.commission_plans (
        ...
        'franchise_network', franchise_version, btrim(p_franchise_name), 'franchise_network',
        p_franchise_commercial_share_bps, p_franchise_share_bps, franchise_central_bps,
        effective_at, p_actor_id
    )
    ...
    LOOP
        ...
        INSERT INTO public.commission_plan_assignments (
            ...
            selected_commercial_id, direct_plan_id, effective_at, p_actor_id, btrim(p_reason)
        );
    END LOOP;

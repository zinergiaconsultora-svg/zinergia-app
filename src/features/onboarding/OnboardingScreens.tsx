...
import {
    ...
    Sparkles, FileText, Send, Users,
    GraduationCap, ChevronRight, TrendingUp,
} from 'lucide-react';
import { updateAgentProfileAction, AgentProfile } from '@/app/actions/profile';

export const STORAGE_KEY = 'zinergia_onboarding_done_v1';
...
export function StepWelcome({ profile, onNext, onSkip }: {
...
export function StepProfile({ profile, onNext, onBack }: {
    profile: AgentProfile;
...
export function StepHowItWorks({ onNext, onBack }: { onNext: () => void; onBack: () => void }) {
...
export function StepReady({ name, onDone, onNavigate }: {
    name: string;
    onDone: () => void;

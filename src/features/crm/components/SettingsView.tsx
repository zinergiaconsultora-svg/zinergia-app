...
export default function SettingsView({
    ...
    const {
        ...
        handleSaveRule, networkNodes, networkLoading, handleSave,
    } = useSettingsView(activeCommissionRule);
        ...
        <div className="min-h-screen bg-[#F8F9FC] pb-12 font-sans text-slate-900 selection:bg-energy-500/30">
            ...
            >
                ...
                {activeTab === 'profile' && (
                    ...
                    >
                        {/* LEFT COLUMN: link a Datos Fiscales */}
                        <div className="col-span-1 md:col-span-4 space-y-6">
                            <div className="bg-blue-50 border border-blue-100 rounded-2xl p-5 text-sm text-blue-800 shadow-sm">
                                ...
                                <p className="opacity-90 leading-relaxed mb-4">
                                    El NIF/CIF, la dirección fiscal y el IBAN —lo que se usa para emitir las
                                    facturas de tus comisiones— se gestionan en <strong>Datos Fiscales</strong>.
                                </p>
                                <button
                                    type="button"
                                    onClick={() => setActiveTab('fiscal')}
                                    className="inline-flex items-center gap-1.5 px-4 py-2 bg-white text-blue-700 border border-blue-200 rounded-xl font-bold text-sm hover:bg-blue-100 transition-colors"
                                >
                                    Ir a Datos Fiscales
                                    <ArrowRight size={15} />
                                </button>
                        ...
                        {/* RIGHT COLUMN: datos básicos de empresa */}
                        <div className="col-span-1 md:col-span-8 space-y-6">
                            <DashboardCard
                                title="Datos de empresa"
                                icon={Building2}
                                subtitle="Nombre comercial que aparecerá en tus ofertas y contratos"
                                className="h-auto"
                            >
                                <div className="mt-2 space-y-2 max-w-md">
                                    ...
                                    <input
                                        ...
                                        placeholder="Ej: Energía Pérez S.L."
                                        className="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-energy-500 focus:ring-4 focus:ring-energy-500/10 outline-none transition-all font-medium text-slate-800"
                                    />
                                    <p className="text-xs text-slate-400">
                                        Pulsa <strong>Guardar</strong> (arriba) para aplicar los cambios.
                                    </p>
                                </div>
                            </DashboardCard>
                        </div>

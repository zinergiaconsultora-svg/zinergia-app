                        ...
                        <div className={`flex flex-col gap-3 min-h-[500px] rounded-2xl transition-all duration-300 p-1 -mx-1 ${
                            ...
                            {columnClients.map(client => (
                                <div
                                    ...
                                    className={`bg-white dark:bg-slate-900 rounded-xl p-3.5 shadow-sm border border-slate-200/70 dark:border-slate-800 cursor-pointer active:cursor-grabbing hover:shadow-md hover:border-indigo-300/50 dark:hover:border-indigo-500/50 hover:bg-slate-50/50 dark:hover:bg-slate-800/50 hover:-translate-y-[1px] transition-all duration-200 group flex flex-col gap-2.5 relative overflow-hidden ${
                                ...
                                >
                                    ...
                                    {/* Información funcional (Compañía / Tarifa) */}
                                    ...
                                    {/* Pie: CUPS y Valor */}
                                    <div className="flex justify-between items-end gap-2 mt-auto pt-1 border-t border-slate-100 dark:border-slate-800">
                                        <div className="min-w-0">
                                            {client.cups ? (
                                                <div className="text-[10px] text-slate-400 dark:text-slate-500 font-mono tracking-wider truncate" title={client.cups}>
                                                    {client.cups.substring(0, 16)}...
                                                </div>
                                            ) : (

...
import { X, Printer, TrendingDown, Zap, CheckCircle2, ArrowRight, BarChart3, Shield, ChevronLeft, ChevronRight, Coins } from 'lucide-react';
        ...
        <>
            ...
            <div id="zinergia-presentation" className="fixed inset-0 z-[200] bg-slate-950 flex flex-col overflow-hidden">
                ...
                <div className="flex-1 relative overflow-hidden">
                    ...
                    {/* ═══ Slide: Detail ═══ */}
                    {slide === 'detail' && (
                        <div className="h-full overflow-auto px-8 py-6 max-w-6xl mx-auto w-full">
                        ...
                        <div className="h-full overflow-auto px-8 py-6 max-w-6xl mx-auto w-full">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                                {results.slice(0, 8).map((r, i) => {
                                    ...
                                    const isBest = i === 0;
                                    return (
                                        <div key={r.offer.id ?? i} className={`rounded-2xl p-5 relative transition-transform hover:scale-[1.02] ${
                                            isBest
                    ...
                    {slide === 'recommendations' && recommendations.length > 0 && (
                        <div className="h-full overflow-auto px-8 py-6 max-w-5xl mx-auto w-full">
                            <h2 className="text-lg font-bold text-white mb-6 flex items-center gap-2">

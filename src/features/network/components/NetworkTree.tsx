...
const ROLE_CONFIG: Record<string, {
    ...
    franchise: {
        ...
        badgeBg: 'bg-indigo-500/20 border-indigo-400/20',
        badgeText: 'text-indigo-300',
        nameCls: 'text-white',
        subCls: 'text-indigo-300/70',
        statLabelCls: 'text-slate-500',
        statValueCls: 'text-slate-200',
        dividerCls: 'border-white/10',
        actionBg: 'bg-white/8',
        actionHover: 'hover:bg-white/15',
        actionText: 'text-slate-300 hover:text-white',
        chevronCls: 'text-slate-400 hover:bg-white/10',
    },
    admin: {
        label: 'Admin',
        icon: <ShieldCheck size={18} strokeWidth={1.8} />,
        cardBg: 'bg-gradient-to-br from-rose-950 via-slate-900 to-slate-900',
        cardBorder: 'border-rose-900/40',
        avatarBg: 'bg-gradient-to-br from-rose-500 to-rose-700',
        avatarText: 'text-white',
        badgeBg: 'bg-rose-500/20 border-rose-400/20',
        badgeText: 'text-rose-300',
        nameCls: 'text-white',
        subCls: 'text-rose-300/70',
        statLabelCls: 'text-slate-500',
        statValueCls: 'text-slate-200',
        dividerCls: 'border-white/10',
        actionBg: 'bg-white/8',
                ...
                >
                    ...
                    `}>
                        ...
                        <div className={`w-1 rounded-l-2xl shrink-0 ${
                            nodeData.role === 'franchise' ? 'bg-indigo-500' :
                            nodeData.role === 'admin' ? 'bg-rose-500' : 'bg-emerald-400'
                        }`} />

            ...
            <div className="space-y-1.5">
                ...
                <div className="relative group">
                    <input
                        ...
                        ref={ref}
                        className={cn(
                            "flex h-11 w-full rounded-2xl border border-slate-200/50 bg-white/40 dark:bg-slate-850/40 dark:border-slate-750/30 px-4 py-2 text-sm placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-energy-500/30 focus:bg-white dark:focus:bg-slate-900 transition-all font-sans text-slate-900 dark:text-slate-100",
                            "hover:bg-white/60 dark:hover:bg-slate-800/60 hover:border-slate-300 dark:hover:border-slate-700",
                            icon ? "pl-11" : "",
                            action ? "pr-10" : "",
                    ...
                    />
                    {icon && (
                        <div className={`absolute left-3.5 top-1/2 -translate-y-1/2 transition-colors ${error ? 'text-red-400' : warning ? 'text-amber-500' : 'text-slate-400 group-focus-within:text-energy-500'}`}>
                            {icon}
                        </div>
                    )}
                    {action && (

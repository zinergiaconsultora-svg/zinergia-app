    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 px-4 py-3 md:px-8 md:py-4 pointer-events-none">
            <motion.div
                ...
                className="fixed top-0 left-0 h-[1.5px] bg-indigo-500 z-[60] shadow-[0_0_8px_rgba(99,102,241,0.5)]"
            />
            ...
            <div className="max-w-[1600px] mx-auto pointer-events-auto">
                <motion.nav
                    ...
                    className="glass-premium rounded-[2rem] border border-white/40 shadow-floating flex items-center justify-between px-6 py-2 md:px-8 bg-white/40"
                >
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="hidden md:flex items-center gap-4 bg-slate-50/50 border border-slate-100 px-4 py-2 rounded-2xl relative overflow-hidden group/shimmer">
                            <motion.div
                            ...
                            <motion.div
                                ...
                                className="w-10 h-10 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center text-white shadow-lg relative z-10"
                            >
                                <Trophy size={18} />
                                <motion.div
                                    className="absolute inset-0 bg-white/20 blur-md rounded-xl opacity-0 hover:opacity-100 transition-opacity"
                                />
                            </motion.div>
                        </div>

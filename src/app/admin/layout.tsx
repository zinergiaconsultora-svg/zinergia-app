...
export default async function AdminLayout({
    ...
    return (
        <NotificationProvider>
            <div className="min-h-[100dvh] bg-slate-50 pt-16 pb-[calc(4.25rem+env(safe-area-inset-bottom,0px))] font-sans text-slate-900 xl:pb-0 dark:bg-slate-950 dark:text-slate-100">
